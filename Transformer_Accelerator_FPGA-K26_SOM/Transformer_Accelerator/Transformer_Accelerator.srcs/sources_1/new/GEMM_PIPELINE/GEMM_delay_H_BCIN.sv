...
module GEMM_delay_H_BCIN #(
    parameter DELAY_LINE_LENGTH = `gemm_instruction_dispatcher_CLOCK_CONSUMPTION + `MINIMUM_DELAY_LINE_LENGTH,
    parameter DELAY_LINE_BANDWIDTH = `gemm_MAC_UNIT_IN_H
) (
    input logic clk,
    input logic rst_n,
