...
`include "GEMV_Vec_Matric_MUL.svh"
...
#(
    parameter gemv_cfg_t param = GEMV_ACC_DEFAULT_CFG
) (
    input logic clk,
    input logic rst_n,
    input logic [float_emax_align_pkg::FIXED_MANT_WIDTH+2:0] IN_reduction_result,
    ...
    output logic [float_emax_align_pkg::FIXED_MANT_WIDTH+2:0] OUT_GEMV_result_vector[0:param.GEMV_BATCH - 1],
    output logic OUT_acc_valid
);

  logic [float_emax_align_pkg::FIXED_MANT_WIDTH+2:0] GEMV_result_vector[0:param.GEMV_BATCH - 1];
